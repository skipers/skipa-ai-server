...
<title>지식재산처 > 지식재산제도 > 특허/실용신안 > 심사기준</title>
</head>
<body>
<!-- 본문바로가기 -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >특허/실용신안</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200146"  class="on" >
           		심사기준</a></li>
			<!-- 3depth child no end -->
				...
				<div class="locate">
					...
					<div class="locate_btn">
						...
						<div class="sns_btns sns_btns_braille" id="sns"><!-- 점자전자서비스 버튼 아이콘 sns_btns_braille CSS 클래스 추가-->
							<a href="javascript:shareSNS('f','심사기준','/ko/kpoContentView.do?menuCd=SCD0200146');" title="페이스북 심사기준공유하기 새창 열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('t','심사기준','/ko/kpoContentView.do?menuCd=SCD0200146');" title="X 심사기준공유하기 새창 열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('b','심사기준','/ko/kpoContentView.do?menuCd=SCD0200146');" title="밴드 심사기준공유하기 새창 열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('k','심사기준','/ko/kpoContentView.do?menuCd=SCD0200146');" title="카카오스토리 심사기준공유하기 새창 열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기 새창 열림"></a>
						...
						<button class="print_btn" onclick="window.print()"><i class="fa fa-print" title="인쇄하기"></i></button>
					 	<button class="brailleviewer_btn" onclick="openBrlViewer('지식재산처 > 지식재산제도 > 특허/실용신안 > 심사기준')"><span class="fa braille_viewer" title="전자점자뷰어보기(새창열림)"></span></button>
						<button class="brailledown_btn" onclick="exportBrl('brl', '지식재산처 > 지식재산제도 > 특허/실용신안 > 심사기준')"><span class="fa braille_down" title="전자점자다운로드"></span></button> 
					</div>
...
<div class="mtitle"><span>특허ㆍ실용신안 심사기준</span> <a class="btn line3 ft_right" href="/ko/kpoContFileDown.do?seq=4&amp;fileNum=1" title="PDF 다운로드">PDF 다운로드</a></div>
...
<div class="comment_box">
		...
		<input type="hidden" name="sMenuCd" id="sMenuCd" value='SCD0200146'>
