...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
 <head> 
  ...
  <!-- 레이아웃 관련 CSS -->      
  <!-- 레이아웃 관련 CSS //--> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.min.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/common/common.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/common/drag_search.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/common/CookieUtil.js"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.loadmask.min.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/common/jquery-custom.js?Time=1780310809"></script> 
  <!-- 레이아웃 관련 JS --> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery-ui.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery-ui_2017.min.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.layout-latest.min.js?Time=1780310809"></script> 
  <script type="text/javascript" src="/LSW/js/common/layout.js?Time=1780310809"></script> 
  <!-- 레이아웃 관련 JS //-->  
  <script type="text/javascript">
        var webRoot = '/LSW';
    </script> 
  <link rel="shortcut icon" type="text/css" href="/LSW/images/ico_favorites.ico" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/common.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/js/jquery/jquery.loadmask.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/js/jquery/layout-default-latest.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/layout.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/board.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/ui_2017.css?Time=1780310809" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/fonts.css?Time=1780310809" />
...
//]]>
  ...
  <form id="translateMode"> 
   <input type="hidden" id="RlsiSeq" name="lsiSeq" value="279827" /> 
   <input type="hidden" id="RjoNo" name="joNo" value="0063" /> 
  ...
  <div id="container"> 
   ...
   <div id="bodySideContent">   
    ...
    <input type="hidden" id="lsiSeq" value="279827" /> 
    <input type="hidden" id="lsId" value="001455" /> 
    <input type="hidden" id="ancYd" value="20251111" /> 
    <input type="hidden" id="ancNo" value="21134" /> 
    <input type="hidden" id="lsNm" value="특허법" /> 
    <input type="hidden" id="lsBdyChrCls" value="010202" /> 
    <input type="hidden" id="lsNmTrim" value="특허법" /> 
...
function delLayer(temp){
    ...
    <div id="conScroll" style="overflow-y:auto;overflow-x:hidden!important;"> 
     ...
     <div class="subtit2 cont_subtit" style="margin-bottom:20px;"> 
      <p> <a href="#" target="_blank" onclick="javascript:cptOfiPop(" http:="" www.kipo.go.kr");return="" false;"="" title="팝업으로 이동"> <span style="cursor:pointer;" title="http://www.kipo.go.kr">지식재산처</span></a>(<span style="cursor:pointer;" title="">특허제도과</span>), 042-481-5400 </p> 
      <p> <a href="#" target="_blank" onclick="javascript:cptOfiPop(" http:="" www.kipo.go.kr");return="" false;"="" title="팝업으로 이동"> <span style="cursor:pointer;" title="http://www.kipo.go.kr">지식재산처</span></a>(<span style="cursor:pointer;" title="">특허심사총괄과</span>), 042-481-5395 </p> 
     </div> 
     <!-- 소관부처 정보 //--> 
