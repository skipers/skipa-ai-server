			...
			<div id="content">
					...
					<ul class="location">
						...
						<div class="sns_btns sns_btns_braille" id="sns">
							<a href="javascript:shareSNS('f','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=16423&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="페이스북 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기"></a>
							<a href="javascript:shareSNS('t','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=16423&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="X 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기"></a>
							<a href="javascript:shareSNS('b','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=16423&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="밴드 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기"></a>
							<a href="javascript:shareSNS('k','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=16423&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="카카오스토리 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기"></a>
...
<!-- 	i값이랑 field_sum2(제목제외,내용전 항목까지 sum) 같으면 colspan=3 표시해주도록 반영 -->
	 	...
	 	<div class="tbl_view">
							...
							<div class="v_tit" data-brl-flag="1" data-brl-colspan="4">BM 특허 길라잡이
							</div>
	  							...
	  							<div class="v_header">
										...
										<div data-brl-flag="6" >전자상거래심사과</div>
										...
										<div data-brl-flag="6" >481-5667</div>
										...
										<div data-brl-flag="6" >특허실용ㆍ실용</div>
										...
										<div data-brl-flag="6" data-brl-colspan=3>3432</div>
						...
						<div class="v_body" data-brl-flag="7" data-brl-colspan="4">
											...
											- 제1장 BM 특허란<br/> · 영업방법도 특허 받을 수 있을까?<br/> · BM 특허의 대상<br/> · BM 특허의 분류<br/> · BM 특허 출원 동향<br/><br/>- 제2장 BM 특허, 출원에서 등록까지<br/> · 출원 전 선행기술조사<br/> · 특허출원<br/> · 심사청구<br/> · 실체심사<br/> · 특허여부 결정<br/><br/>- 제3장 BM 특허의 명세서 작성 및 거절이유 대응<br/> · 특허출원 서류<br/> · 명세서 양식 및 작성 요령<br/> · 특허요건 위반 사례 및 대응<br/> · 의견제출통지 및 그 후의 절차<br/><br/>- 제4장 BM 특허의 활용 및 보호 사례<br/> · BM 특허를 기반으로 성장한 세계 최대 전자상거래업체<br/> · 공유경제의 등장과 BM 특허<br/> · BM 특허 분쟁 사례 1<br/> · BM 특허 분쟁 사례 2<br/> · BM 특허 분쟁 사례 3<br/> · BM 특허 분쟁 사례 4<br/> · BM 특허 분쟁 사례 5<br/> · BM 특허 사례 소개<br/> · 외국의 BM 특허 사례 소개 1<br/> · 외국의 BM 특허 사례 소개 2<br/><br/>- 부록 : 알아두면 유익한 정보 
							...
							<div class="v_bottom">
								...
								<div data-brl-flag="6" data-brl-colspan="3">
											...
											<!-- 23.09.11 첨부파일 url 형식 변경  -->
												<a href="/ko/kpoBultnFileDown.do?ntatcSeq=16423&ntatcAtflSeq=2&sysCd=SCD02&aprchId=BUT0000048" style="cursor: pointer;" title="5.BM 길라잡이.pdf.pdf 다운로드">5.BM 길라잡이.pdf.pdf</a>
	
												
													<a class="btn line5" onclick="fileViewer('16423','2','BUT0000048');" href="#1" title="5.BM 길라잡이.pdf.pdf 미리보기(새창열림)" >미리보기</a>
...
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
			                			<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=16424&sysCd=SCD02&aprchId=BUT0000048" title="2020년도 지식재산활동 실태조사" >2020년도 지식재산활동 실태조사</a>
...
<!-- 										</a> -->
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
										<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=16422&sysCd=SCD02&aprchId=BUT0000048" title="영업비밀 판례노트" >영업비밀 판례노트</a>
...
<div class="comment_box">
		...
		<input type="hidden" name="sNtatcSeq" id="sNtatcSeq" value='16423'>
