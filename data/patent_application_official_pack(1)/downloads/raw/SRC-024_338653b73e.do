...
<html lang="ko">
	<head>
		...
		<meta name="format-detection" content="telephone=no">
				...
				<meta name="title" property="og:title" content="지식재산처_KIPRISPlus_거절결정서_REST API"/>
		...
		<meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
				...
				<title>지식재산처_KIPRISPlus_거절결정서_REST API | 공공데이터포털</title>
...
<link rel="stylesheet" href="/css/app.min.css?t=202606152_1946" media="all">
...
<script type="application/ld+json">
    {
        ...
        "@type":"Dataset",
        "name":"지식재산처_KIPRISPlus_거절결정서_REST API",
        "description":"1. 개요 지식재산권(특허, 실용, 디자인, 상표)의 출원에 대한 거절 결정을 통보하는거절결정서와 관련한 정보를 제공합니다. 출원에 대한 심사관의 심사결과로 거절이유가 해소되지 않은 사유를 기재하여 해당 출원인에게 거절결정이 통지되는 특허청의 발송 서류 정보를 API(REST방식) 및 대용량(BULK)으로 제공합니다.  2. 세부 정보 내용 ① 서지정보: 출원번호, 디자인일련번호, 문서내 출원번호 등의 정보를 XML 형태로 제공합니다. ② 심사관정보: 작성일, 심사국, 심사관 명 등의 정보를 XML 형태로 제공합니다. ③ PDF정보: PDF파일 다운로드 주소를 XML 형태로 제공합니다. 출원일자, 출원번호, 발명의 명칭, 이의신청일자, 이의신청번호, 제출기한일자, 기술평가일자, 심사결과, 거절결정내용 등  ※ 월 1,000회까지 무료 호출 가능 합니다. 해당 횟수 이상의 호출이 필요하시거나, BULK 데이터 사용이 필요하신 경우 서비스 홈페이지(plus.kipris.or.kr)를 통해 사용이 가능 합니다.",
        "url": "https://data.go.kr/data/15056951/openapi.do",
        "keywords":[
            "출원일자,출원번호,이의신청일자,거절결정내용 ,심사결과"
        ],
        ...
        "distribution":[
            {
                "@type":"DataDownload",
                "encodingFormat":"XML",
                "contentUrl": "https://data.go.kr/data/15056951/openapi.do"
            }
        ],
...
<div class="data-search-view">
    ...
    <div class="data-set-title open-api">
        <div class="tit-area">
            ...
            <p class="tit open-api-title">지식재산처_KIPRISPlus_거절결정서_REST API</p>
            <input type="hidden" id="publicDataDetailPk"
                   value="uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608"/>
            <input type="hidden" id="publicDataPk" value="15056951"/>
        </div>
...
<!-- 2020-01-21 : 마크업 오류 수정 -->
        ...
        ">
                    ...
                    <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" title="새창 열림"
                       class="button mb-3 link-api-btn" onclick="fn_LinkApiRequest('uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608')">
...
<script>
    ...
    <div class="dataset-openapi-info">
            ...
            <div class="flex-tit">
                ...
                <div class="dropdown ml-2">
                    ...
                    <div class="dropdown-content">
                        <a href="/catalog/15056951/openapi.json"
                           target="_blank">schema.org</a>
                        <a href="/dcat/metadata/15056951"
        ...
        <div class="flex-tit align-items-center justify-content-space-between">
            <a href="javascript:fn_callDataImproveReportPopup('', 'O', '15056951','uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608', '')" class="button error-btn just-pc" title="새 창으로 문의 열기">
                데이터 개선요청
            </a>
            <a href="javascript:fn_callErrorReportPopup('', 'O', '15056951','uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608', '');" class="button error-btn just-pc ml-2" title="새 창으로 문의 열기">
                오류신고 및 문의
            </a>
        </div>
    </div>
...
<table class="dataset-table">
    <caption>지식재산처_KIPRISPlus_거절결정서_REST API로 오픈 API 정보 표로 분류체계, 제공기관 등 정보를 나타냄</caption>
    ...
    <tr class="bg-skyblue tr">
        <th class="th custom-cell-border-bottom custom-cell-border-right">활용신청</th>
                ...
                <td class="td custom-cell-border-bottom">39</td>
            
        
        <th class="th custom-cell-border-bottom custom-cell-border-right">키워드</th>
        <td class="td custom-cell-border-bottom">출원일자,출원번호,이의신청일자,거절결정내용 ,심사결과</td>
    </tr>
    <tr class="bg-skyblue tr">
        ...
        <tr class="bg-skyblue tr">
            ...
            <td class="td custom-cell-border-bottom" colspan="2">
				<a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" onclick="fn_LinkApiRequest('uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608')"
                    title="새 창으로 열기">
					http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&amp;subTab=SC002
				</a>
			</td>
        </tr>
...
<script>
 ...
 <h3 class="tit">
		...
		<div>
			...
			">
				...
				">
					...
					<div class="dropdown-content">
						<a href="/catalog/15056951/openapi.json" target="_blank">schema.org</a>
						<a href="/dcat/metadata/15056951" target="_blank">DCAT</a>
					</div>
				</div>
	...
	<div class="mobile-btns d-flex mt-3">
		<a href="javascript:fn_callDataImproveReportPopup('', 'O', '15056951','uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608', '')" class="button error-btn mr-2 mb-btn" title="새 창으로 문의 열기">
			데이터 개선요청
		</a>
		<a href="javascript:fn_callErrorReportPopup('', 'O', '15056951','uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608', '');" class="button error-btn mb-btn" title="새 창으로 문의 열기">
			오류신고 및 문의
		</a>
	</div>
</h3>
...
<table class="dataset-table">
	...
	<tr class="bg-skyblue tr">
		...
		<tr class="bg-skyblue tr">
			<th class="th custom-cell-border-bottom custom-cell-border-right">URL</th>
			<td class="td custom-cell-border-bottom" colspan="2"><a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" onclick="fn_LinkApiRequest('uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608')">http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&amp;subTab=SC002</a></td>
		</tr>
...
<div class="custom-row mb-4">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-0-pc" data-pk="15032196" data-dpk="uddi:a88f1aed-5c2a-46b1-818b-e0c5c3578be8" data-code="FILE">
            ...
            <div>
                    ...
                    <a href="/data/15032196/fileData.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_이의신청사항 서지</span>
                    </a>
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-0-mobile" data-pk="15032196" data-dpk="uddi:a88f1aed-5c2a-46b1-818b-e0c5c3578be8" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-1-pc" data-pk="15046711" data-dpk="uddi:3ee39093-ffd4-46aa-96a5-bd8dda2d8061_201810081821" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-1-mobile" data-pk="15046711" data-dpk="uddi:3ee39093-ffd4-46aa-96a5-bd8dda2d8061_201810081821" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-2-pc" data-pk="15053826" data-dpk="uddi:d454f261-d995-4661-af0b-95cfb9d1910b_201810081416" data-code="FILE">
            <div class="tag-area mb-2">
            ...
            <div>
                    ...
                    <a href="/data/15053826/fileData.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_PCT 공개공보</span>
                    </a>
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-2-mobile" data-pk="15053826" data-dpk="uddi:d454f261-d995-4661-af0b-95cfb9d1910b_201810081416" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-3-pc" data-pk="15059446" data-dpk="uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&subTab=SC002" id="file_link_pc_3" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605')" title="바로가기">
                            바로가기
                        </a>
            ...
            <div>
                    ...
                    <a href="/data/15059446/openapi.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_의견제출통지서_REST API</span>
                    </a>
                
            </div>
        </div>
        <div class="col-2dot4 recommend-mobile" id="recommend-data-3-mobile" data-pk="15059446" data-dpk="uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&subTab=SC002" id="file_link_mb_3" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605')" title="바로가기" style="padding: ">
                            바로가기
                        </a>
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-4-pc" data-pk="15085728" data-dpk="uddi:99a69aa7-be87-40ca-bad5-a72da93d602c_202509231616" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="https://plus.kipris.or.kr/portal/data/service/DBII_000000000000417/view.do?menuNo=210169" id="file_link_pc_4" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:99a69aa7-be87-40ca-bad5-a72da93d602c_202509231616')" title="바로가기">
                            바로가기
                        </a>
            ...
            <div>
                    ...
                    <a href="/data/15085728/openapi.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_일본 특허 합금조성비_REST API</span>
                    </a>
                
            </div>
        </div>
        <div class="col-2dot4 recommend-mobile" id="recommend-data-4-mobile" data-pk="15085728" data-dpk="uddi:99a69aa7-be87-40ca-bad5-a72da93d602c_202509231616" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="https://plus.kipris.or.kr/portal/data/service/DBII_000000000000417/view.do?menuNo=210169" id="file_link_mb_4" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:99a69aa7-be87-40ca-bad5-a72da93d602c_202509231616')" title="바로가기" style="padding: ">
                            바로가기
                        </a>
