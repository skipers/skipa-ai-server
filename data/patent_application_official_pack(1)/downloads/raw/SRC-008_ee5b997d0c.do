...
<title>지식재산처 > 책자/통계 > 간행물 > 지식재산 심사 기준/매뉴얼</title>
</head>
<body>
<!-- 본문바로가기 -->
...
<div id="lnb">
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >간행물</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201119"  class="on" >
           		지식재산 심사 기준/매뉴얼</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200640&parntMenuCd2=SCD0200281"   >
           		기타 간행물</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop end -->
			...
			<div id="content">
				...
				<div class="locate">
					<h2 data-brl-use="PT">지식재산 심사 기준/매뉴얼</h2>
					<ul class="location">
					...
					<div class="locate_btn">
						...
						<div class="sns_btns sns_btns_braille" id="sns"><!-- 점자전자서비스 버튼 아이콘 sns_btns_braille CSS 클래스 추가-->
							<a href="javascript:shareSNS('f','지식재산 심사 기준/매뉴얼','/ko/kpoContentView.do?menuCd=SCD0201119');" title="페이스북 지식재산 심사 기준/매뉴얼공유하기 새창 열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('t','지식재산 심사 기준/매뉴얼','/ko/kpoContentView.do?menuCd=SCD0201119');" title="X 지식재산 심사 기준/매뉴얼공유하기 새창 열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('b','지식재산 심사 기준/매뉴얼','/ko/kpoContentView.do?menuCd=SCD0201119');" title="밴드 지식재산 심사 기준/매뉴얼공유하기 새창 열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('k','지식재산 심사 기준/매뉴얼','/ko/kpoContentView.do?menuCd=SCD0201119');" title="카카오스토리 지식재산 심사 기준/매뉴얼공유하기 새창 열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기 새창 열림"></a>
						...
						<button class="print_btn" onclick="window.print()"><i class="fa fa-print" title="인쇄하기"></i></button>
					 	<button class="brailleviewer_btn" onclick="openBrlViewer('지식재산처 > 책자/통계 > 간행물 > 지식재산 심사 기준/매뉴얼')"><span class="fa braille_viewer" title="전자점자뷰어보기(새창열림)"></span></button>
						<button class="brailledown_btn" onclick="exportBrl('brl', '지식재산처 > 책자/통계 > 간행물 > 지식재산 심사 기준/매뉴얼')"><span class="fa braille_down" title="전자점자다운로드"></span></button> 
					</div>
          	...
          	<!-- 내용 : s -->
				<div class="page_con" data-brl-use="PH">
<div class="page_info">
<ul class="manual">
	<li><a href="#manual1">특허&middot;실용신안 심사기준</a> (2026.03.12)</li>
	<li><a href="#manual2">기술분야별 심사실무가이드</a> (2026.03)</li>
	<li><a href="#manual3">PCT 국제조사 및 국제예비심사 가이드라인</a> (2026.01)</li>
	<li><a href="#manual4">상표심사기준</a> (2025.12.10)</li>
	<li><a href="#manual5">디자인 심사기준</a> (2025.11.28)</li>
	<li><a href="#manual6">유사상품 심사기준(니스13판, 2026)</a> (2026.01)</li>
	<li><a href="#manual7">출원방식심사기준 </a> (2022.08)</li>
	<li><a href="#manual8">등록업무 편람</a> (2022.11)</li>
	<li><a href="#manual9">NICE 국제상품분류 Class Heading 해설서</a> (2017)</li>
	<li><a href="#manual10">상품 및 서비스업 분류목록 (한글 가다다순, 니스 제9판 기준)</a> (2007.02)</li>
	<li><a href="#manual11">디자인 물품류별 물품목록</a> (2026)</li>
	<li><a href="#manual12">디자이너를 위한 디자인출원도면 작성 가이드북</a> (2026.05)</li>
	<li><a href="#manual13">지식재산권 권리회복 심사 가이드라인</a>&nbsp;(2022.04.20)</li>
</ul>

<p class="right">※개정시 신속하게 업데이트 하겠습니다.</p>
</div>

<div class="simsa" id="manual1">
<div class="mbox"><img alt="특허ㆍ실용신안 심사기준" src="/resource/images/guideline.jpg" /></div>

<div class="mlist">
<h3 class="mtit">특허ㆍ실용신안 심사기준<span>(2026.03.12)</span></h3>

<p class="ct1">관련내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=1" title="특허ㆍ실용신안 심사기준 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />특허ㆍ실용신안 심사기준</a></div>
...
<hr />
<div class="simsa" id="manual2">
<div class="mbox"><img alt="기술분야별 심사실무가이드" src="/resource/images/guideline44.jpg?v=20260114" /></div>

<div class="mlist">
<h3 class="mtit">기술분야별 심사실무가이드<span>(2026.03)</span></h3>

<p class="ct1">관련내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=2" title="기술분야별 심사실무가이드 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />기술분야별 심사실무가이드</a></div>

<ul class="list_01">
	<li>제1부. 인공지능 분야</li>
	<li>제2부. IoT 서비스 분야</li>
	<li>제3부. 바이오분야</li>
	<li>제4부. 식물 분야</li>
	<li>제5부. 의약 분야</li>
	<li>제6부. 지능형로봇 분야</li>
	...
	<li>제9부. 화합물 분야</li>
	<li>제10부. 화장품 분야</li>
	<li>제11부. 디지털 헬스케어 분야</li>
	<li>제12부. 반도체 분야</li>
	<li>기타(구 기술분야별 심사기준)</li>
</ul>
</div>
</div>

<hr />
<div class="simsa" id="manual3">
<div class="mbox"><img alt="PCT 국제조사/국제예비심사 매뉴얼" src="/resource/images/criterion_17.png?v=20260128" /></div>

<div class="mlist">
<h3 class="mtit">PCT 국제조사 및 국제예비심사 가이드라인<span>(2026.01)</span></h3>

<p class="ct1">우리처에서 발간하는 PCT 국제조사 및 국제예비심사 가이드라인을 열람하실 수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=3" title="PCT 국제조사 및 국제예비심사 가이드라인 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />PCT 국제조사 및 국제예비심사 가이드라인</a></div>

<ul class="list_01">
	<li>제1부. 서론 및 개관</li>
	<li>제2부. 국제출원</li>
	<li>제3부. 국제조사기관과 국제예비심사기관에 공통된 심사관의 고려사항</li>
	<li>제4부. 국제조사</li>
	<li>제5부. 견해서 및 국제예비심사보고서의 내용</li>
	<li>제6부. 국제예비심사단계(국제예비보고서 제외)</li>
	<li>제7부. 품질</li>
	<li>제8부. 사무 및 행정절차</li>
</ul>
</div>
...
<hr />
<div class="simsa" id="manual4">
<div class="mbox"><img alt="상표심사기준" src="/resource/images/criterion_01.jpg" /></div>

<div class="mlist">
<h3 class="mtit">상표심사기준<span>(2025.12.10)</span></h3>

<p class="ct1">내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=4" title="상표심사기준 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />상표심사기준</a></div>

<ul class="list_01">
	<li>제1부. 총 칙</li>
	<li>제2부. 상표등록출원</li>
	<li>제3부. 출원의 보정&middot;분할&middot;변경</li>
	<li>제4부. 상표등록의 요건</li>
	<li>제5부. 상표등록을 받을 수 없는 상표</li>
	<li>제6부. 심사일반</li>
	<li>제7부. 상표 이외의 권리에 대한 심사</li>
	<li>제8부. 비전형상표에 대한 심사</li>
	<li>제9부. 국제상표심사기준의 특례</li>
	<li>제10부. 보칙</li>
</ul>
</div>
</div>
...
<hr />
<div class="simsa" id="manual5">
<div class="mbox"><img alt="디자인 심사기준" src="/resource/images/design_2025.png" /></div>

<div class="mlist">
<h3 class="mtit">디자인 심사기준<span>(2025.11.28)</span></h3>

<p class="ct1">내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=5" title="디자인 심사기준 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자인 심사기준</a></div>

<ul class="list_01">
	<li>제1부. 총 칙</li>
	<li>제2부. 디자인등록의 요건 및 부등록 사유</li>
	<li>제3부. 디자인의 유사여부 판단</li>
	<li>제4부. 출원의 보정 및 분할</li>
	<li>제5부. 심사일반</li>
	<li>제6부. 특유물품심사</li>
	<li>부칙</li>
</ul>
...
<hr />
<div class="simsa" id="manual10">
<div class="mbox"><img alt="상품 및 서비스업 분류목록(한글 가다다순, 니스 제9판 기준)" src="/resource/images/criterion_11.png" /></div>

<div class="mlist">
<h3 class="mtit">상품 및 서비스업 분류목록(한글 가다다순, 니스 제9판 기준)<span>(2007.02)</span></h3>

<p class="ct1">우리처에서 발간하는 상품 및 서비스업 분류목록을 열람하실 수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=6" title="심사자료, 니스 제9판 기준PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />심사자료, 니스 제9판 기준</a></div>
</div>
</div>

<hr />
<div class="simsa" id="manual6">
<div class="mbox"><img alt="유사상품 심사기준" src="/resource/images/criterion_2026.png" /></div>

<div class="mlist">
<h3 class="mtit">유사상품 심사기준(니스13판, 2026)<span>(2026.01)</span></h3>

<p class="ct1">우리처에서 발간하는 유사상품 심사기준을 열람하실 수 있습니다.</p>

<div class="mtitle">
<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=25" title="유사상품 심사기준(니스 제13판 기준)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품 심사기준(니스 제13판 기준)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=7" title="유사상품 심사기준(니스 제12판 기준)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품 심사기준(니스 제12판 기준)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=8" title="유사상품 심사기준(니스 제11판 기준)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품 심사기준(니스 제11판 기준)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=9" title="유사상품·서비스업 심사기준(니스 제10판 기준)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품&middot;서비스업 심사기준(니스 제10판 기준)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=10" title="유사상품·서비스업 심사기준(니스 제9판 기준) PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품&middot;서비스업 심사기준(니스 제9판 기준)</a></p>

<p><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=11" title="유사상품·서비스업 심사기준(니스 제8판 기준)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />유사상품&middot;서비스업 심사기준(니스 제8판 기준)</a></p>
</div>
</div>
</div>

<hr />
<div class="simsa" id="manual7">
<div class="mbox"><img alt="출원방식심사기준" src="/resource/images/criterion_21.png" /></div>

<div class="mlist">
<h3 class="mtit">출원방식심사기준<span>(2022.08)</span></h3>

<p class="ct1">우리처에서 발간하는 출원방식심사기준을 열람하실 수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=12" title="출원방식심사기준 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />출원방식심사기준</a></div>
</div>
</div>

<hr />
<div class="simsa" id="manual8">
<div class="mbox"><img alt="등록업무 편람" src="/resource/images/criterion_22.png?v=2023012601" /></div>

<div class="mlist">
<h3 class="mtit">등록업무 편람<span>(2022.11)</span></h3>

<p class="ct1">우리처에서 발간하는 등록업무 편람을 열람하실 수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=13" title="등록업무 편람 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />등록업무 편람</a></div>
</div>
</div>

<hr />
<div class="simsa" id="manual9">
<div class="mbox"><img alt="NICE 국제상품분류 Class Heading 해설서" src="/resource/images/criterion_23.png" /></div>

<div class="mlist">
<h3 class="mtit">NICE 국제상품분류 Class Heading 해설서</h3>

<p class="ct1">우리처에서 발간하는 NICE 국제상품분류 Class Heading 해설서를 열람하실 수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=14" title="NICE 국제상품분류 Class Heading 해설서 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />NICE 국제상품분류 Class Heading 해설서</a></div>
</div>
</div>

<hr />
<div class="simsa" id="manual11">
<div class="mbox"><img alt="디자인 물품류별 물품목록" src="/resource/images/criterion_1219.png" /></div>

<div class="mlist">
<h3 class="mtit">디자인 물품류별 물품목록<span>(2026)</span></h3>

<p class="ct1">관련내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle">
<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=24" title="디자인 물품류별 물품목록(2026년)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자인 물품류별 물품목록 (2026년)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=23" title="디자인 물품류별 물품목록(2025년)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자인 물품류별 물품목록 (2025년)</a></p>

<p class="mb10"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=22" title="디자인 물품류별 물품목록(2024년)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자인 물품류별 물품목록 (2024년)</a></p>

<p><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=15" title="디자인 물품류별 물품목록(2021년)PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자인 물품류별 물품목록 (2021년)</a></p>
</div>
</div>
</div>

<hr />
<div class="simsa" id="manual12">
<div class="mbox"><img alt="디자이너를 위한 디자인출원도면 작성 가이드북" src="/resource/images/criterion_03_1.png" /></div>

<div class="mlist">
<h3 class="mtit">디자이너를 위한 디자인출원도면 작성 가이드북<span>(2026.05)</span></h3>

<p class="ct1">관련내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=19" title="디자이너를 위한 디자인출원도면 작성 가이드북 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />디자이너를 위한 디자인출원도면 작성 가이드북</a></div>
</div>
</div>

<hr />
<div class="simsa" id="manual13">
<div class="mbox"><img alt="지식재산권 권리회복 심사 가이드라인" src="/resource/images/exguide_01.png" /></div>

<div class="mlist">
<h3 class="mtit">지식재산권 권리회복 심사 가이드라인<span>(2022.04.20)</span></h3>

<p class="ct1">관련내용을 PDF전문다운로드 받아 보실수 있습니다.</p>

<div class="mtitle"><a href="/ko/kpoContFileDown.do?seq=30&amp;fileNum=20" title="지식재산권 권리회복 심사 가이드라인 PDF 다운로드"><img alt="PDF 다운로드" src="/resource/images/down_pdf.png" />지식재산권 권리회복 심사 가이드라인</a></div>
...
<ul class="list_01">
	...
	<li>제4부. 권리회복 신청</li>
	<li>제5부. 권리회복 심사</li>
	<li>제6부. 권리회복 기간 심사</li>
	<li>제7부. 권리회복 요건 심사</li>
	<li>제8부. 권리회복 심사 사례</li>
</ul>
</div>
</div>

<hr />
<p class="ct1">관련 내용을 보기위해선 관련 뷰어 프로그램이 필요합니다.</p>
<a class="btn line3" href="/kipo/kipoContentView.do?menuCd=SCD0201127" target="_blank" title="뷰어프로그램 다운로드(새창)">뷰어 프로그램 다운로드</a></div>
...
<div class="comment_box">
		...
		<input type="hidden" name="sMenuCd" id="sMenuCd" value='SCD0201119'>
