...
<!-- header -->
	...
	<div class="layout">
		...
		<a href="/"><img src="/resource/images/moip_logo2.png?v=2025100101" alt="지식재산처"></a>
			...
			<li><a href="javascript:;" class="active" ><span>책자/통계</span></a>
				<div class="sub">
					<div class="m_inner">
						<div class="subM">
...
<div id="lnb">
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >법령 및 조약</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200286"   >
           		지식재산권 법령체계도</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200637&parntMenuCd2=SCD0200280"   >
           		최근개정법령</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200638&parntMenuCd2=SCD0200280"   >
           		입법예고</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200639&parntMenuCd2=SCD0200280"   >
           		최근 개정 훈령/예규/고시</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child yes start -->
				<li><a href="SCD0200287" >국제조약 및 기타</a>
					<ul>
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200288"   >
	              		PCT</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200289"   >
	              		FTA 추진현황</a></li>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200290"   >
           		고문변호사 소개</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="http://www.law.go.kr/main.html" target="_blank"  title="국가법령정보센터 바로가기(새창)"  >
           		국가법령정보센터</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="https://elaw.klri.re.kr/kor_service/lawTotalSearchSogan.do" target="_blank"  title="대한민국 영문법령 바로가기(새창)"  >
           		대한민국 영문법령</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >간행물</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0201112&parntMenuCd2=SCD0200281"   >
           		정책용역, 연구보고서</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201119"   >
           		지식재산 심사 기준/매뉴얼</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child yes start -->
				<li><a href="SCD0200292" >지식재산 백서</a>
					<ul>
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200293"   >
	              		2025년 지식재산 백서</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200294"   >
	              		지난 백서보기</a></li>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&parntMenuCd2=SCD0200281"   >
           		주요 발행물</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200640&parntMenuCd2=SCD0200281"  class="on" >
           		기타 간행물</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/publication/kpoPublicationPgmMgmt.do?menuCd=SCD0200659&parntMenuCd2=SCD0200281"   >
           		지식재산과 혁신/지식재산연구</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="http://library.kipo.go.kr/" target="_blank" title="지식재산처 도서관 바로가기(새창)" >지식재산처 도서관</a></li>
		<!-- child no end -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >통계</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200295"   >
           		이번달 주요 통계</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="https://ipstat.kiip.re.kr/" target="_blank"  title="지식재산권 통계 바로가기(새창)"  >
           		지식재산권 통계</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/stat/kpoStatPgmMgmt.do?menuCd=SCD0200661&parntMenuCd2=SCD0200284"   >
           		통계 간행물</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop start -->
		...
		<!-- 2depth child yes start -->
		<li><a href="#" >첨단전략산업 글로벌 기술동향과 특허</a>
			<ul>
			<!-- 3depth loop start -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201291"   >
           		글로벌 정책동향</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child yes start -->
				<li><a href="SCD0201292" >기술 분야별 동향</a>
					<ul>
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201293"   >
	              		반도체</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201294"   >
	              		디스플레이</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201295"   >
	              		이차전지</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201297"   >
	              		첨단 모빌리티</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201298"   >
	              		차세대 원자력</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201296"   >
	              		첨단바이오</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201299"   >
	              		우주항공·해양</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201300"   >
	              		수소</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201301"   >
	              		사이버보안</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201302"   >
	              		인공지능</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201303"   >
	              		차세대통신</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201304"   >
	              		첨단로봇·제조</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0201305"   >
	              		양자</a></li>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0201306&parntMenuCd2=SCD0201290"   >
           		지난 동향</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >지식재산 동향</a>
			...
			<!-- 3depth child yes start -->
				<li><a href="SCD0200297" >국내외지재권 동향</a>
					<ul>
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/intProperty/kpoIntPropertyPgmMgmt.do?menuCd=SCD0201166&parntMenuCd2=SCD0200297"   >
	              		통계로 보는 특허동향</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200298"   >
	              		세계 지식재산동향</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200641&parntMenuCd2=SCD0200297"   >
	              		해외지식재산센터(해외IP센터)자료</a></li>
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200299"   >
	              		국외행사 정보</a></li>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/semi/kpoSemiPgmMgmt.do?menuCd=SCD0201133&parntMenuCd2=SCD0200285"   >
           		반도체배치설계권 동향</a></li>
			<!-- 3depth child no end -->
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/kpoBultnMgmt.do?menuCd=SCD0200642&parntMenuCd2=SCD0200285"   >
           		의약관련특허 동향</a></li>
			<!-- 3depth child no end -->
	...
	<!-- 2depth loop end -->
			...
			<div id="content">
					...
					<h2 data-brl-use="PT">기타 간행물(상세)</h2>
					<ul class="location">
						...
						<li class="depth1">
							<span>
								...
								<a href="/ko/naviMenuLink.do?menuCd=SCD0200279">책자/통계</a>
						...
						<li class="depth1">
							<span>
								...
								<a href="/ko/naviMenuLink.do?menuCd=SCD0200281">간행물</a>
						...
						<div class="sns_btns sns_btns_braille" id="sns">
							<a href="javascript:shareSNS('f','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=17056&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="페이스북 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기"></a>
							<a href="javascript:shareSNS('t','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=17056&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="X 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기"></a>
							<a href="javascript:shareSNS('b','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=17056&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="밴드 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기"></a>
							<a href="javascript:shareSNS('k','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=17056&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=SCD02&menuCd=SCD0200640&keyword=');" title="카카오스토리 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기"></a>
						...
						<button class="print_btn" onclick="window.print()"><i class="fa fa-print" title="인쇄하기"></i></button>
					 	<button class="brailleviewer_btn" onclick="openBrlViewer('지식재산처 > 책자/통계 > 간행물 > 기타 간행물')"><span class="fa braille_viewer" title="전자점자뷰어보기(새창열림)"></span></button>
						<button class="brailledown_btn" onclick="exportBrl('brl', '지식재산처 > 책자/통계 > 간행물 > 기타 간행물')"><span class="fa braille_down" title="전자점자다운로드"></span></button>
					</div>
				</div>
				<article class="txt">
          <!-- 리스트 : s -->
		...
		<form id="listForm" name="listForm" action="/ko/kpoBultnMgmt.do">
			<input type="hidden" name="menuCd" value="SCD0200640">
			<input type="hidden" name="aprchId" value="BUT0000048">
...
<!-- 	i값이랑 field_sum2(제목제외,내용전 항목까지 sum) 같으면 colspan=3 표시해주도록 반영 -->
	 	...
	 	<div class="tbl_view">
							...
							<div class="v_tit" data-brl-flag="1" data-brl-colspan="4">2026 지식재산권의 손쉬운 이용
							</div>
	  							...
	  							<div class="v_header">
										...
										<div data-brl-flag="6" >지식재산등록과</div>
										...
										<div data-brl-flag="6" >042-481-5142</div>
										...
										<strong data-brl-flag="5">분류</strong>
										<div data-brl-flag="6" >기타</div>
										...
										<div data-brl-flag="6" data-brl-colspan=3>211</div>
									
									</div>
						<div class="v_body" data-brl-flag="7" data-brl-colspan="4">
						
									 
												<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt">제</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">1</span></span></span><span style="font-size:11.0pt">장 지식재산권의 이해</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅰ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">지식재산권 개요</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅱ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">지식재산권 기초 다지기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt">제</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">2</span></span></span><span style="font-size:11.0pt">장 출원에서 등록까지</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅰ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">출원 전</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">, </span></span></span><span style="font-size:11.0pt">선행기술 정보검색</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅱ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">출원 따라하기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅲ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">심사 알아보기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅳ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">등록 신청하기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅴ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">심판절차 밟기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅵ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">수수료 납부하기</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt">제</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">3</span></span></span><span style="font-size:11.0pt">장 알아두면 유익한 정보</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅰ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">지식재산고객 서비스 업무</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅱ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">지식재산 지원시책</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="letter-spacing:0pt"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅲ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">지식재산권 관련 알기 쉬운 </span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">Q&amp;A</span></span></span></span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt"><span style="letter-spacing:0pt">Ⅳ</span></span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">. </span></span></span><span style="font-size:11.0pt">기타 서비스별 유용한 정보</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span style="font-size:11.0pt">붙임</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">01. </span></span></span><span style="font-size:11.0pt">자주 문의하는 서식리스트 및 작성예제</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">02. </span></span></span><span style="font-size:11.0pt">지식재산처 지원 기관 현황</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">03. </span></span></span><span style="font-size:11.0pt">지역지식재산센터 현황</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">04. </span></span></span><span style="font-size:11.0pt">주요 국가 지식재산관청 인터넷 주소</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">05. </span></span></span><span style="font-size:11.0pt">해외특허 검색사이트</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">06. </span></span></span><span style="font-size:11.0pt">국내 지식재산권 관련 기관 인터넷 주소</span></span></span></span><br />
<span style="font-size:11.0pt"><span style="line-height:130%"><span style="text-autospace:none"><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">07. </span></span></span><span style="font-size:11.0pt">출원</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">&middot;</span></span></span><span style="font-size:11.0pt">등록</span><span lang="EN-US" style="font-size:11.0pt"><span style="font-family:굴림"><span style="letter-spacing:0pt">&middot;</span></span></span><span style="font-size:11.0pt">심사 및 심판 주요통계</span></span></span></span><br />
<span style="line-height:130%"><span style="text-autospace:none"></span></span><br />
&nbsp;
							...
							<div class="v_bottom">
								...
								<div data-brl-flag="6" data-brl-colspan="3">
											...
											<!-- 23.09.11 첨부파일 url 형식 변경  -->
												<a href="/ko/kpoBultnFileDown.do?ntatcSeq=17056&ntatcAtflSeq=1&sysCd=SCD02&aprchId=BUT0000048" style="cursor: pointer;" title="13.2026 지식재산권의 손쉬운 이용.pdf 다운로드">13.2026 지식재산권의 손쉬운 이용.pdf</a>
	
												
													<a class="btn line5" onclick="fileViewer('17056','1','BUT0000048');" href="#1" title="13.2026 지식재산권의 손쉬운 이용.pdf 미리보기(새창열림)" >미리보기</a>
...
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
			                			<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=17057&sysCd=SCD02&aprchId=BUT0000048" title="심결취소소송 정리집(통권 제40호)" >심결취소소송 정리집(통권 제40호)</a>
...
<!-- 										</a> -->
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
										<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=17055&sysCd=SCD02&aprchId=BUT0000048" title="연구개발 효율성 및 성과 제고를 위한 지식재산권 전략적 조사·분석 품질관리 매뉴얼" >연구개발 효율성 및 성과 제고를 위한 지식재산권 전략적 조사·분석 품질관리 매뉴얼</a>
...
<div class="comment_box">
		...
		<input type="hidden" name="sMenuCd" id="sMenuCd" value='SCD0200640'>
		<input type="hidden" name="sSysCd" id="sSysCd" value='SCD02'>
		<input type="hidden" name="bultnId" id="bultnId" value='BUT0000048'>
		<!-- 23.07.07_lys.호환성 오류(ID 중복) 조치, ntatcSeq > sNtatcSeq 로 수정 -->
		<input type="hidden" name="sNtatcSeq" id="sNtatcSeq" value='17056'>
...
<footer id="footer">
	...
	<!--// footer E-->
        ...
        <form action="/ko/kpoBultnDetail.do" name="subDetailFrm" id="subDetailFrm" method="post">
	        ...
	        <input type="hidden" id="menuCd" name="menuCd" value="SCD0200640">
			<input type="hidden" id="aprchId" name="aprchId" value="BUT0000048">
