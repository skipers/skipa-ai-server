...
<div id="lnb">
	...
	<!-- 2depth loop end -->
			...
			<div id="content">
					...
					<ul class="location">
						...
						<div class="sns_btns sns_btns_braille" id="sns">
							<a href="javascript:shareSNS('f','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=10148&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=&menuCd=SCD0200640&keyword=');" title="페이스북 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기"></a>
							<a href="javascript:shareSNS('t','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=10148&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=&menuCd=SCD0200640&keyword=');" title="X 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기"></a>
							<a href="javascript:shareSNS('b','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=10148&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=&menuCd=SCD0200640&keyword=');" title="밴드 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기"></a>
							<a href="javascript:shareSNS('k','기타 간행물','/ko/kpoBultnDetail.do?ntatcSeq=10148&aprchId=BUT0000048&searchCondition=&pageIndex=&sysCd=&menuCd=SCD0200640&keyword=');" title="카카오스토리 기타 간행물 공유하기 새창열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기"></a>
		...
		<form id="listForm" name="listForm" action="/ko/kpoBultnMgmt.do">
			...
			<input type="hidden" name="sysCd" value="">
...
<!-- 	i값이랑 field_sum2(제목제외,내용전 항목까지 sum) 같으면 colspan=3 표시해주도록 반영 -->
	 	...
	 	<div class="tbl_view">
							...
							<div class="v_tit" data-brl-flag="1" data-brl-colspan="4">통지서 표준 문안집
							</div>
	  							...
	  							<div class="v_header">
										...
										<div data-brl-flag="6" >489-3207</div>
										...
										<div data-brl-flag="6" data-brl-colspan=3>3008</div>
							...
							<div class="v_bottom">
								...
								<div data-brl-flag="6" data-brl-colspan="3">
											...
											<!-- 23.09.11 첨부파일 url 형식 변경  -->
												<a href="/ko/kpoBultnFileDown.do?ntatcSeq=10148&ntatcAtflSeq=1&sysCd=&aprchId=BUT0000048" style="cursor: pointer;" title="통지서표준문안집.pdf 다운로드">통지서표준문안집.pdf</a>
	
												
													<a class="btn line5" onclick="fileViewer('10148','1','BUT0000048');" href="#1" title="통지서표준문안집.pdf 미리보기(새창열림)" >미리보기</a>
...
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
			                			<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=10149&sysCd=&aprchId=BUT0000048" title="특허청 보안업무 실무" >특허청 보안업무 실무</a>
...
<!-- 										</a> -->
<!-- 								23.10.19 김승현 주무관님 요청으로 .do 뒤 파라미터 보이게 url 형식 변경 -->
										<a href="/ko/kpoBultnDetail.do?menuCd=SCD0200640&ntatcSeq=10147&sysCd=&aprchId=BUT0000048" title="출원방식심사지침서" >출원방식심사지침서</a>
...
<div class="comment_box">
		...
		<input type="hidden" name="sNtatcSeq" id="sNtatcSeq" value='10148'>
...
<footer id="footer">
	...
	<!--// footer E-->
        ...
        <form action="/ko/kpoBultnDetail.do" name="subDetailFrm" id="subDetailFrm" method="post">
	        ...
	        <input type="hidden" id="sysCd" name="sysCd" value="">
