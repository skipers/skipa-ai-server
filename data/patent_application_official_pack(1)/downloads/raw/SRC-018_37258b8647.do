...
<script>
	...
	function searchBoard() {
		//26.05.19 국민평가 결과(사용자 경험(UX) 및 기능 내 검색어 입력 없이 검색 시 경고 메시지를 명확히 표시해야 함.)에 따른 검색어 미입력시 알림창 띄우기
	...
	//26.05.19 국민평가 결과(사용자 경험(UX) 및 기능 내 검색어 입력 없이 검색 시 경고 메시지를 명확히 표시해야 함.)에 따른 검색취소 시 내용 초기화, 초기화면으로 이동되도록 수정
	function reset() {
	...
	function fileDown(pgmSeq, pgmId) {
		document.forms.issueFileFrm.pgmSeq.value = pgmSeq;
		document.forms.issueFileFrm.pgmId.value = pgmId;

		document.forms.issueFileFrm.submit();
	}
</script>
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >간행물</a>
			...
			<!-- 3depth child no start -->
           	...
           	<li><a href="/ko/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&parntMenuCd2=SCD0200281"  class="on" >
           		주요 발행물</a></li>
			<!-- 3depth child no end -->
				...
				<div id="content">
					<div class="locate">
						...
						<div class="locate_btn">
							<button class="sns_btn" onclick="sns()">
								<span class="hide">sns공유하기(페이스북,X,밴드,카카오스토리)</span><i class="fa fa-share-alt" title="SNS공유하기"></i>
							</button>
							<div class="sns_btns" id="sns">
								<a href="javascript:shareSNS('f','주요 발행물','/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&pgmId=PGM0000021&sysCd=SCD02');" title="페이스북 주요 발행물 공유하기 새창열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기"></a>
								<a href="javascript:shareSNS('t','주요 발행물','/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&pgmId=PGM0000021&sysCd=SCD02');" title="X 주요 발행물 공유하기 새창열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기"></a>
								<a href="javascript:shareSNS('b','주요 발행물','/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&pgmId=PGM0000021&sysCd=SCD02');" title="밴드 주요 발행물 공유하기 새창열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기"></a>
								<a href="javascript:shareSNS('k','주요 발행물','/issue/kpoIssuePgmMgmt.do?menuCd=SCD0200658&pgmId=PGM0000021&sysCd=SCD02');" title="카카오스토리 주요 발행물 공유하기 새창열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기"></a>
								<button class="close_btn" onclick="sns()">
									<i class="fa fa-times" title="SNS공유하기 닫기"></i>
									<span class="hide">SNS공유하기 닫기</span>
								</button>
							</div>
					...
					<article class="txt">
						...
						<div class="defSchWrap">
							<div class="defSchBox">
								<div class="defSch">
									<form id="listForm" name="listForm" action="/ko/issue/kpoIssuePgmMgmt.do">
										<input type="hidden" id="pageIndex" name="pageIndex" value="">
										<input type="hidden" id="curMenuCd" name="curMenuCd" value="">
										<input type="hidden" id="menuCd" name="menuCd" value="SCD0200658">
										<input type="hidden" name="sysCd" value="SCD02">
										<input type="hidden" id="parntMenuCd2" name="parntMenuCd2" value="SCD0200281">
										...
										<a href="#" class="btn srch" id="searchBtn" onclick="searchBoard();">검색</a>
										
										<a href="#" class="btn cancel" id="resetBtn" onclick="reset();">검색취소</a>
									</form>
								</div>
							</div>
						</div>
						...
						<!-- 리스트 : s -->
								...
								<div class="photo_list">
									<span class="p_cnt">총 : 97건, 1/10(Page)
									</span>
									<ul>
										
											<li>
												<a href="javascript:;" title="BM 특허 길라잡이(2025년 개정판) PDF 다운로드" onclick="fileDown('118','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=118&pgmId=PGM0000021" width="125" height="170" alt="BM 특허 길라잡이(2025년 개정판)">
														</span>
													</span>
													<span class="date">발행일자 : 2025.12
														
														<img src="/resource/images/ico_pdf.gif" width="16" height="16" alt="PDF 첨부파일">
													</span>
													<strong class="subject" title="BM 특허 길라잡이(2025년 개정판) PDF 다운로드">BM 특허 길라잡이(2025년 개정판)</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="2026 지식재산권의 손쉬운 이용 PDF 다운로드" onclick="fileDown('117','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=117&pgmId=PGM0000021" width="125" height="170" alt="2026 지식재산권의 손쉬운 이용">
														</span>
													</span>
													<span class="date">발행일자 : 2026.01
														
														<img src="/resource/images/ico_pdf.gif" width="16" height="16" alt="PDF 첨부파일">
													</span>
													<strong class="subject" title="2026 지식재산권의 손쉬운 이용 PDF 다운로드">2026 지식재산권의 손쉬운 이용</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="2025 지식재산고객 상담사례집 PDF 다운로드" onclick="fileDown('116','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=116&pgmId=PGM0000021" width="125" height="170" alt="2025 지식재산고객 상담사례집">
														</span>
													</span>
													<span class="date">발행일자 : 2025.12
													...
													<strong class="subject" title="2025 지식재산고객 상담사례집 PDF 다운로드">2025 지식재산고객 상담사례집</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="지식재산권 전략적 조사·분석 가이드라인 PDF 다운로드" onclick="fileDown('115','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=115&pgmId=PGM0000021" width="125" height="170" alt="지식재산권 전략적 조사·분석 가이드라인">
														</span>
													</span>
													<span class="date">발행일자 : 2025.12
													...
													<strong class="subject" title="지식재산권 전략적 조사·분석 가이드라인 PDF 다운로드">지식재산권 전략적 조사·분석 가이드라인</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="지식재산권 전략적 조사·분석 품질관리 매뉴얼 PDF 다운로드" onclick="fileDown('114','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=114&pgmId=PGM0000021" width="125" height="170" alt="지식재산권 전략적 조사·분석 품질관리 매뉴얼">
														</span>
													</span>
													<span class="date">발행일자 : 2025.12
													...
													<strong class="subject" title="지식재산권 전략적 조사·분석 품질관리 매뉴얼 PDF 다운로드">지식재산권 전략적 조사·분석 품질관리 매뉴얼</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="헤이그 사용자 가이드 PDF 다운로드" onclick="fileDown('112','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=112&pgmId=PGM0000021" width="125" height="170" alt="헤이그 사용자 가이드">
														</span>
													</span>
													<span class="date">발행일자 : 2025.08
														
														<img src="/resource/images/ico_pdf.gif" width="16" height="16" alt="PDF 첨부파일">
													</span>
													<strong class="subject" title="헤이그 사용자 가이드 PDF 다운로드">헤이그 사용자 가이드</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="헤이그협정(제네바 개정협정)·시행규칙·행정지침 PDF 다운로드" onclick="fileDown('113','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=113&pgmId=PGM0000021" width="125" height="170" alt="헤이그협정(제네바 개정협정)·시행규칙·행정지침">
														</span>
													</span>
													<span class="date">발행일자 : 2025.08
													...
													<strong class="subject" title="헤이그협정(제네바 개정협정)·시행규칙·행정지침 PDF 다운로드">헤이그협정(제네바 개정협정)·시행규칙·행정지침</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="2025 지식재산권의 손쉬운 이용 PDF 다운로드" onclick="fileDown('111','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=111&pgmId=PGM0000021" width="125" height="170" alt="2025 지식재산권의 손쉬운 이용">
														</span>
													</span>
													<span class="date">발행일자 : 2025.01
														
														<img src="/resource/images/ico_pdf.gif" width="16" height="16" alt="PDF 첨부파일">
													</span>
													<strong class="subject" title="2025 지식재산권의 손쉬운 이용 PDF 다운로드">2025 지식재산권의 손쉬운 이용</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="2025년도 특허청 지식재산 지원 시책 PDF 다운로드" onclick="fileDown('110','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=110&pgmId=PGM0000021" width="125" height="170" alt="2025년도 특허청 지식재산 지원 시책">
														</span>
													</span>
													<span class="date">발행일자 : 2025.01
													...
													<strong class="subject" title="2025년도 특허청 지식재산 지원 시책 PDF 다운로드">2025년도 특허청 지식재산 지원 시책</strong>
												</a>
											</li>
										
											<li>
												<a href="javascript:;" title="2024년 특허고객상담 사례집 PDF 다운로드" onclick="fileDown('109','PGM0000021');">
													<span class="photo">
														<span>
															
															<img src="/ko/issue/imageIssueUrlView.do?pgmSeq=109&pgmId=PGM0000021" width="125" height="170" alt="2024년 특허고객상담 사례집">
														</span>
													</span>
													<span class="date">발행일자 : 2024.12
														
														<img src="/resource/images/ico_pdf.gif" width="16" height="16" alt="PDF 첨부파일">
													</span>
													<strong class="subject" title="2024년 특허고객상담 사례집 PDF 다운로드">2024년 특허고객상담 사례집</strong>
												</a>
											</li>
						...
						<div class="pagination">
							...
							<strong>1</strong>&#160;<a href="#" onclick="fn_egov_link_page(2); return false;" title="2">2</a>&#160;<a href="#" onclick="fn_egov_link_page(3); return false;" title="3">3</a>&#160;<a href="#" onclick="fn_egov_link_page(4); return false;" title="4">4</a>&#160;<a href="#" onclick="fn_egov_link_page(5); return false;" title="5">5</a>&#160;<a href="#" onclick="fn_egov_link_page(6); return false;" title="6">6</a>&#160;<a href="#" onclick="fn_egov_link_page(7); return false;" title="7">7</a>&#160;<a href="#" onclick="fn_egov_link_page(8); return false;" title="8">8</a>&#160;<a href="#" onclick="fn_egov_link_page(9); return false;" title="9">9</a>&#160;<a href="#" onclick="fn_egov_link_page(10); return false;" title="10">10</a>&#160;
						...
						<div class="pagenation pageNum">
							...
							<span class="currentPage"><em>1</em>/10</span>
...
<div class="comment_box">
		...
		<input type="hidden" name="sMenuCd" id="sMenuCd" value='SCD0200658'>
...
<script>
	viewSatisfaction();
		...
		<form action="/ko/issue/kpoIssueFileDown.do" name="issueFileFrm" id="issueFileFrm" method="post">
			<input type="hidden" id="pgmSeq" name="pgmSeq" value="">
			<input type="hidden" id="pgmAtflSeq" name="pgmAtflSeq" value="">
			<input type="hidden" id="pgmId" name="pgmId" value="PGM0000021">
			<input type="hidden" name="sysCd" value="SCD02">
		</form>
