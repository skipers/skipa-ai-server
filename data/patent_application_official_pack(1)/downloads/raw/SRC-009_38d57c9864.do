...
<title>지식재산처 > 지식재산제도 > 특허/실용신안 > 특허심사3.0 > 보정안 리뷰</title>
</head>
<body>
<!-- 본문바로가기 -->
	...
	<!-- 2depth loop start -->
		...
		<li><a href="#" >특허/실용신안</a>
			...
			<!-- 3depth child yes start -->
				<li><a href="SCD0200113" class="on">특허심사3.0</a>
					<ul>
					<!-- 4depth loop start -->
					...
					<!-- 4depth loop start -->
	              	...
	              	<li><a href="/ko/kpoContentView.do?menuCd=SCD0200117"  class="on" >
	              		보정안 리뷰</a></li>
				...
				<div class="locate">
					...
					<ul class="location">
						...
						<li class="depth1">
							<span>
									...
									<a href="/ko/naviMenuLink.do?menuCd=SCD0200113">특허심사3.0</a>
					...
					<div class="locate_btn">
						...
						<div class="sns_btns sns_btns_braille" id="sns"><!-- 점자전자서비스 버튼 아이콘 sns_btns_braille CSS 클래스 추가-->
							<a href="javascript:shareSNS('f','보정안 리뷰','/ko/kpoContentView.do?menuCd=SCD0200117');" title="페이스북 보정안 리뷰공유하기 새창 열림"><img src="/resource/images/sns_fb_b.png" alt="페이스북 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('t','보정안 리뷰','/ko/kpoContentView.do?menuCd=SCD0200117');" title="X 보정안 리뷰공유하기 새창 열림"><img src="/resource/images/sns_tw_b.png" alt="X 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('b','보정안 리뷰','/ko/kpoContentView.do?menuCd=SCD0200117');" title="밴드 보정안 리뷰공유하기 새창 열림"><img src="/resource/images/sns_blog_b.png" alt="밴드 공유하기 새창 열림"></a>
							<a href="javascript:shareSNS('k','보정안 리뷰','/ko/kpoContentView.do?menuCd=SCD0200117');" title="카카오스토리 보정안 리뷰공유하기 새창 열림"><img src="/resource/images/sns_kakao_b.png" alt="카카오스토리 공유하기 새창 열림"></a>
						...
						<button class="print_btn" onclick="window.print()"><i class="fa fa-print" title="인쇄하기"></i></button>
					 	<button class="brailleviewer_btn" onclick="openBrlViewer('지식재산처 > 지식재산제도 > 특허/실용신안 > 특허심사3.0 > 보정안 리뷰')"><span class="fa braille_viewer" title="전자점자뷰어보기(새창열림)"></span></button>
						<button class="brailledown_btn" onclick="exportBrl('brl', '지식재산처 > 지식재산제도 > 특허/실용신안 > 특허심사3.0 > 보정안 리뷰')"><span class="fa braille_down" title="전자점자다운로드"></span></button> 
					</div>
...
<h3 class="Ftit pt0">보정안 리뷰(사전 검토) 개요</h3>

<ul class="list_01">
	<li><strong>보정안 리뷰 제도란?</strong>

	<p class="ct1">출원인이 통지된 거절이유에 대응한 최종 보정서를 제출하기 전에 심사관과의 면담을 통해 보정안에 대한 의견을 교환하는 제도</p>

	<div class="cimg"><img alt="거절이유를 해소하는방법? 적절한 권리를 만드려면 어떻게 보정해야할지 고민하는 이미지" src="/rhksfl/ckImageSubmit.do?uid=944fce65-9768-4cd6-afc2-f98128d8e868&amp;fileName=patent_simsa07.jpg&amp;lastPath=2022%2F0114&amp;sysCd=SCD01" /></div>
	</li>
	<li><strong>보정안 리뷰 제도의 효과</strong>
	<p class="ct1">출원인은 보정안의 거절이유 해소 여부 등을 최종 보정서 제출전에 파악하여 대응함으로써 불필요한 절차를 줄여 특허결정 시기를 앞당길 수 있고, 심사관은 출원인과 직접 기술 및 심사의견을 교환함으로써 정확한 심사를 도모할 수 있음</p>
	</li>
	<li><strong>보정안 리뷰 대상 출원</strong>
	<ul class="list_02">
		<li>① 심사관이 거절이유를 통지한 출원 중</li>
		<li>② 보정서 제출기간 만료일 1개월 이전이 되는 날까지 보정안을 제출한 출원</li>
		<li>※ 보정안은 보정서 또는 의견서의 형태로 보정안 리뷰 신청 전에 제출되어야 함</li>
	</ul>
	</li>
</ul>
...
<p class="ct1">(최후)의견제출통지서 통지 &rarr; ① 보정안 리뷰 신청 &rarr; ② 보정안 리뷰 결정 &rarr; ③ 면담 실시 &rarr; ④ 보정서제출</p>

<div class="cimg"><img alt="" src="https://www.moip.go.kr/rhksfl/ckImageSubmit.do?uid=41ba899d-cdfd-4e76-af15-244dcd9c67df&amp;fileName=%EB%B3%B4%EC%A0%95%EC%95%88%EB%A6%AC%EB%B7%B0+%EC%8B%AC%EC%82%AC%EA%B8%B0%EC%A4%80+%EA%B7%B8%EB%A6%BC.PNG&amp;lastPath=2026%2F0410&amp;sysCd=SCD01" /></div>
<a class="btn line cbtn" href="/resource/images/patent/patent_simsa08.jpg" target="_blank" title="보정안 리뷰 절차 큰 이미지로 보기(새창)">큰 이미지로 보기</a>

<ul class="list_02">
	<li><strong>① 보정안 리뷰 신청</strong>

	<ul class="list_03 ml15">
		<li>(신청방법) 보정서 제출기간 만료일 1개월 이전이 되는 날까지 전자출원 포털사이트 &#39;특허로&#39; (<a href="http://patent.go.kr/" target="_blank" title="특허로홈페이지 바로가기(새창)">http://patent.go.kr</a>)의 &lsquo;신청제출 - 면담신청/정보제공 - 보정안리뷰&rsquo; 메뉴를 통해 신청양식을 작성<br />
		※ 보정서 제출기간의 연장을 신청한 경우 연장된 기간의 만료일 1개월 이전이 되는 날까지 보정안 리뷰 신청 가능</li>
		<li>면담 희망일시(보정안 리뷰 신청일로부터 1주 후부터 보정서 제출기간 만료일 이내), 면담 참석자(대리인이 없는 경우 출원인 반드시 참석) 등 기재</li>
	</ul>
	</li>
	<li><strong>② 보정안 리뷰 결정</strong>
	<ul class="list_03 ml15">
		<li>보정안 제출 여부, 신청일시, 면담 참석자 등 보정안 리뷰 신청의 적합 여부를 고려하여 신청 후 7일 이내 보정안 리뷰 대상으로 결정 또는 반려</li>
		<li>보정안 리뷰 결정여부는 전자출원 포털사이트 &#39;특허로&#39; (<a href="http://patent.go.kr/" target="_blank" title="특허로홈페이지 바로가기(새창)">http://patent.go.kr</a>)의 &lsquo;신청제출 - 면담신청/정보제공 - 보정안리뷰 - 신청/조회&rsquo; 메뉴를 통해 확인</li>
	</ul>
	</li>
	<li><strong>③ 면담 실시</strong>
	<ul class="list_03 ml15">
		<li>(심사관) 면담 전에 보정안에 대해 사전검토한 심사 결과를 출원인 등에게 설명</li>
		<li>(출원인) 기술 설명 및 심사관의 사전검토결과에 대한 의견 개진</li>
		<li>(보정방향 협의) 심사관이 발견한 거절이유를 해소할 수 있는 방향에 대한 출원인과 심사관의 협의 진행
		<p class="ct1">※ 면담 후 면담기록서를 작성하고 출원인과 심사관 등 면담 참석자 서명</p>
		</li>
	</ul>
	</li>
	<li><strong>④ 보정서 제출</strong>
	<p class="ct1">- 보정서(의견서) 제출기간 만료일까지 보정서 제출</p>
	</li>
</ul>

<p class="ct1">※ 자세한 내용은 특허&middot;실용신안 심사기준 제8부제5장을 참고하시기 바랍니다. <a class="btn add2" href="/ko/kpoContFileDown.do?seq=3&amp;fileNum=1" title="특허·실용신안 심사기준_보정안리뷰 PDF 다운로드">다운로드</a></p>
</div>
...
<div class="comment_box">
        ...
        <div class="user_info">
			<span class="kcall">상담센터(1544-8080)</span>
				...
				<span class="part"> 담당자 : 특허제도과 이예원 &vert; 042-481-5397
				
					 &vert; 최종수정일 : 2026-04-10
		...
		<input type="hidden" name="sMenuCd" id="sMenuCd" value='SCD0200117'>
