...
<html lang="ko">
	<head>
		...
		<meta name="format-detection" content="telephone=no">
				...
				<meta name="title" property="og:title" content="지식재산처_KIPRISPlus_의견제출통지서_REST API"/>
				...
				<meta name="description" property="og:description" content="1. 개요 지식재산권(특허, 실용, 디자인, 상표)의 출원에 대한 심사 결과에 따른 거절 이유를 통보하는 의견제출통지서와 관련한 정보를 제공합니다. 출원에 대한 심사관의 심사결과로 거절이유가 있어 그 이유를 기재하여 해당 출원인에게 통지되는 특허청의 발송 서류정보를 API(REST방식) 및 대용량(BULK)으로 제공합니다.  2. 세부 정보 내용 ① 서지정보: 출원번호, 디자인일련번호, 문서내 출원번호 등의 정보를 XML 형태로 제공합니다. ② 심사관정보: 작성일, 심사국, 심사관 명 등의 정보를 XML 형태로 제공합니다. ③ PDF정보: PDF파일 다운로드 주소를 XML 형태로 제공합니다. 출원일자, 출원번호, 발명의 명칭, 이의신청일자, 이의신청번호, 제출기한일자, 기술평가일자, 심사결과, 거절결정내용 등  ※ 월 1,000회까지 무료 호출 가능 합니다. 해당 횟수 이상의 호출이 필요하시거나, BULK 데이터 사용이 필요하신 경우 서비스 홈페이지(plus.kipris.or.kr)를 통해 사용이 가능 합니다."/>
			
			
		

		<meta name="url" property="og:url" content="https://www.data.go.kr/data/15059446/openapi.do"/>
		...
		<meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
				...
				<title>지식재산처_KIPRISPlus_의견제출통지서_REST API | 공공데이터포털</title>
...
<link rel="stylesheet" href="/css/app.min.css?t=202606152_2000" media="all">
...
<script type="application/ld+json">
    {
        ...
        "@type":"Dataset",
        "name":"지식재산처_KIPRISPlus_의견제출통지서_REST API",
        "description":"1. 개요 지식재산권(특허, 실용, 디자인, 상표)의 출원에 대한 심사 결과에 따른 거절 이유를 통보하는 의견제출통지서와 관련한 정보를 제공합니다. 출원에 대한 심사관의 심사결과로 거절이유가 있어 그 이유를 기재하여 해당 출원인에게 통지되는 특허청의 발송 서류정보를 API(REST방식) 및 대용량(BULK)으로 제공합니다.  2. 세부 정보 내용 ① 서지정보: 출원번호, 디자인일련번호, 문서내 출원번호 등의 정보를 XML 형태로 제공합니다. ② 심사관정보: 작성일, 심사국, 심사관 명 등의 정보를 XML 형태로 제공합니다. ③ PDF정보: PDF파일 다운로드 주소를 XML 형태로 제공합니다. 출원일자, 출원번호, 발명의 명칭, 이의신청일자, 이의신청번호, 제출기한일자, 기술평가일자, 심사결과, 거절결정내용 등  ※ 월 1,000회까지 무료 호출 가능 합니다. 해당 횟수 이상의 호출이 필요하시거나, BULK 데이터 사용이 필요하신 경우 서비스 홈페이지(plus.kipris.or.kr)를 통해 사용이 가능 합니다.",
        "url": "https://data.go.kr/data/15059446/openapi.do",
        "keywords":[
            "거절결정내용,심사관정보,서지정보,출원일자,출원번호"
        ],
        ...
        "creator":{
            ...
            "contactPoint":{
                "@type":"ContactPoint",
                "contactType": "한국특허정보원 IP정보확산실",
                "telephone":"+82-0269151464"
            }
        },
        ...
        "distribution":[
            {
                "@type":"DataDownload",
                "encodingFormat":"XML",
                "contentUrl": "https://data.go.kr/data/15059446/openapi.do"
            }
        ],
        "datasetTimeInterval":"실시간"
    }
</script>
...
<div class="data-search-view">
    ...
    <div class="data-set-title open-api">
        <div class="tit-area">
            ...
            <p class="tit open-api-title">지식재산처_KIPRISPlus_의견제출통지서_REST API</p>
            <input type="hidden" id="publicDataDetailPk"
                   value="uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605"/>
            <input type="hidden" id="publicDataPk" value="15059446"/>
        </div>
...
<!-- 2020-01-21 : 마크업 오류 수정 -->
        ...
        ">
                    ...
                    <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" title="새창 열림"
                       class="button mb-3 link-api-btn" onclick="fn_LinkApiRequest('uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605')">
...
<script>
    ...
    <div class="dataset-openapi-info">
            ...
            <div class="flex-tit">
                ...
                <div class="dropdown ml-2">
                    ...
                    <div class="dropdown-content">
                        <a href="/catalog/15059446/openapi.json"
                           target="_blank">schema.org</a>
                        <a href="/dcat/metadata/15059446"
        ...
        <div class="flex-tit align-items-center justify-content-space-between">
            <a href="javascript:fn_callDataImproveReportPopup('', 'O', '15059446','uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605', '')" class="button error-btn just-pc" title="새 창으로 문의 열기">
                데이터 개선요청
            </a>
            <a href="javascript:fn_callErrorReportPopup('', 'O', '15059446','uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605', '');" class="button error-btn just-pc ml-2" title="새 창으로 문의 열기">
                오류신고 및 문의
            </a>
        </div>
    </div>
...
<table class="dataset-table">
    <caption>지식재산처_KIPRISPlus_의견제출통지서_REST API로 오픈 API 정보 표로 분류체계, 제공기관 등 정보를 나타냄</caption>
    <tr class="bg-beige tr">
        ...
        <td class="td custom-cell-border-bottom">
            ...
            <a href="/tcs/dss/selectDataSetList.do?dType=&keyword=&org=지식재산처&orgFilter=지식재산처&orgFullName=지식재산처&conditionType=search">
                지식재산처
            </a>
        </td>
    </tr>
    ...
    <tr class="bg-skyblue tr">
        <th class="th custom-cell-border-bottom custom-cell-border-right">활용신청</th>
                ...
                <td class="td custom-cell-border-bottom">38</td>
            
        
        <th class="th custom-cell-border-bottom custom-cell-border-right">키워드</th>
        <td class="td custom-cell-border-bottom">거절결정내용,심사관정보,서지정보,출원일자,출원번호</td>
    </tr>
    <tr class="bg-skyblue tr">
        <th class="th custom-cell-border-bottom custom-cell-border-right">등록일</th>
        <td class="td custom-cell-border-bottom">2018-10-19</td>
        ...
        <tr class="bg-skyblue tr">
            ...
            <td class="td custom-cell-border-bottom" colspan="2">
				<a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" onclick="fn_LinkApiRequest('uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605')"
                    title="새 창으로 열기">
					http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&amp;subTab=SC002
				</a>
			</td>
        </tr>
    ...
    <tr class="bg-skyblue tr">
        ...
        <td class="td custom-cell-border-bottom">실시간</td>
...
<script>
 ...
 <h3 class="tit">
		...
		<div>
			...
			">
				...
				">
					...
					<div class="dropdown-content">
						<a href="/catalog/15059446/openapi.json" target="_blank">schema.org</a>
						<a href="/dcat/metadata/15059446" target="_blank">DCAT</a>
					</div>
				</div>
	...
	<div class="mobile-btns d-flex mt-3">
		<a href="javascript:fn_callDataImproveReportPopup('', 'O', '15059446','uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605', '')" class="button error-btn mr-2 mb-btn" title="새 창으로 문의 열기">
			데이터 개선요청
		</a>
		<a href="javascript:fn_callErrorReportPopup('', 'O', '15059446','uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605', '');" class="button error-btn mb-btn" title="새 창으로 문의 열기">
			오류신고 및 문의
		</a>
	</div>
</h3>
...
<table class="dataset-table">
	...
	<tr class="bg-skyblue tr">
		...
		<tr class="bg-skyblue tr">
			<th class="th custom-cell-border-bottom custom-cell-border-right">URL</th>
			<td class="td custom-cell-border-bottom" colspan="2"><a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&amp;subTab=SC002" target="_blank" onclick="fn_LinkApiRequest('uddi:f6e81146-898f-40a1-b424-af73eb61af95_202509221605')">http://plus.kipris.or.kr/portal/data/util/DBII_000000000000242/view.do?menuNo=210003&amp;subTab=SC002</a></td>
		</tr>
	...
	<tr class="bg-green tr">
		<th class="th custom-cell-border-bottom custom-cell-border-right">업데이트 주기</th>
		<td class="td custom-cell-border-bottom" colspan="2">실시간</td>
	</tr>
	<tr class="bg-green tr">
		<th class="th custom-cell-border-bottom custom-cell-border-right">신청가능 트래픽</th>
		<td class="td custom-cell-border-bottom">
...
<div class="custom-row mb-4">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-0-pc" data-pk="15046711" data-dpk="uddi:3ee39093-ffd4-46aa-96a5-bd8dda2d8061_201810081821" data-code="FILE">
            ...
            <div>
                    ...
                    <a href="/data/15046711/fileData.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_거절결정서</span>
                    </a>
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-0-mobile" data-pk="15046711" data-dpk="uddi:3ee39093-ffd4-46aa-96a5-bd8dda2d8061_201810081821" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-1-pc" data-pk="15046712" data-dpk="uddi:000bd875-2a4b-421b-8578-acc4ed96706c_201810081823" data-code="FILE">
            <div class="tag-area mb-2">
            ...
            <div>
                    ...
                    <a href="/data/15046712/fileData.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_의견제출통지서</span>
                    </a>
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-1-mobile" data-pk="15046712" data-dpk="uddi:000bd875-2a4b-421b-8578-acc4ed96706c_201810081823" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-2-pc" data-pk="15046713" data-dpk="uddi:3a6bc628-7201-4af1-a4e8-fffa9e0d2b6f" data-code="FILE">
            <div class="tag-area mb-2">
            ...
            <div>
                    ...
                    <a href="/data/15046713/fileData.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_등록결정서</span>
                    </a>
        ...
        <div class="col-2dot4 recommend-mobile" id="recommend-data-2-mobile" data-pk="15046713" data-dpk="uddi:3a6bc628-7201-4af1-a4e8-fffa9e0d2b6f" data-code="FILE">
            <div class="tag-area mb-2">
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-3-pc" data-pk="15056951" data-dpk="uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&subTab=SC002" id="file_link_pc_3" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608')" title="바로가기">
                            바로가기
                        </a>
            ...
            <div>
                    ...
                    <a href="/data/15056951/openapi.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_거절결정서_REST API</span>
                    </a>
                
            </div>
        </div>
        <div class="col-2dot4 recommend-mobile" id="recommend-data-3-mobile" data-pk="15056951" data-dpk="uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000243/view.do?menuNo=210003&subTab=SC002" id="file_link_mb_3" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:24eb8180-38e5-4aac-aede-da04bb6cff0b_202509221608')" title="바로가기" style="padding: ">
                            바로가기
                        </a>
        ...
        <div class="col-2dot4 recommend-pc" id="recommend-data-4-pc" data-pk="15065447" data-dpk="uddi:3c323cd7-0091-46b1-b3d9-af6d30a82cc6_202509231129" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000012/view.do?menuNo=210002&subTab=SC002" id="file_link_pc_4" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:3c323cd7-0091-46b1-b3d9-af6d30a82cc6_202509231129')" title="바로가기">
                            바로가기
                        </a>
            ...
            <div>
                    ...
                    <a href="/data/15065447/openapi.do?recommendDataYn=Y" style="text-decoration: none;">
                                <span class="title" style="color: #333; font-size: 16px;">지식재산처_KIPRISPlus_상표 출원 속보_REST API</span>
                    </a>
                
            </div>
        </div>
        <div class="col-2dot4 recommend-mobile" id="recommend-data-4-mobile" data-pk="15065447" data-dpk="uddi:3c323cd7-0091-46b1-b3d9-af6d30a82cc6_202509231129" data-code="API">
            <div class="tag-area mb-2">
                ...
                <div class="bottom-area" style="display: inline; float: right;">
                        ...
                        <a href="http://plus.kipris.or.kr/portal/data/util/DBII_000000000000012/view.do?menuNo=210002&subTab=SC002" id="file_link_mb_4" class="iconset ico-link black ml-2" target="_blank" title="새창 열림" onclick="fn_LinkApiRequest('uddi:3c323cd7-0091-46b1-b3d9-af6d30a82cc6_202509231129')" title="바로가기" style="padding: ">
                            바로가기
                        </a>
