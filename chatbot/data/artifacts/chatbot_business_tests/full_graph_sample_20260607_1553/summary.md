...
- Avg elapsed: 5.118 sec
- Avg source count: 3.95
- Avg quality score: 0.3587
- Intent counts: `{"patent_report": 9, "patent_original": 5, "general": 2, "comparison": 4}`
- Answer mode counts: `{"None": 20}`

## Patent Application Chatbot

- Total / success / failed: 10 / 10 / 0
- Avg elapsed: 0.001 sec
- Avg source count: 0
- Avg quality score: None
- Intent counts: `{"None": 10}`
- Answer mode counts: `{"require_failed_patent_case_before_chat": 10}`
