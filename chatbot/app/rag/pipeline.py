...
_DEEP_DETAIL_TERMS = ("더 자세하게", "자세하게", "자세히", "상세하게", "구체적으로", "깊게", "분석해", "왜", "근거", "리스크", "평가")
...
def _build_format_instruction(
    ...
    *,
    ...
    if answer_depth == "brief":
        parts.append("답변 길이: 사용자가 짧게 요청했으므로 3-6문장 안에서 핵심만 답하세요.")
        ...
        parts.append("답변 길이: 표면적인 한두 문장으로 끝내지 말고, 질문에 필요한 근거 해석을 함께 제공합니다.")
